<?php
  ...
  if($usertype == "authority"){
  	$sql_query="INSERT INTO authority (name,email,password,phone,username)
  VALUES ('$name','$email','$password' ,'$phone','$username') ";
  $data = mysqli_query($conn,$sql_query);
   
  }
  
  else if($usertype == "support"){
  	$sql_query="INSERT INTO support (name,email,password,phone,username)
  VALUES ('$name','$email','$password' ,'$phone','$username') ";
  $data = mysqli_query($conn,$sql_query);
...
<script src="https://use.fontawesome.com/b5e9fd525f.js"></script>
 ...
 <a href="/Stadium/php/add.php?rn=21" ><img src="/Stadium/images/add.svg" height="5%" width="5%" style="position: fixed;left:1%;"></a>
 <br>
...
<tbody>
  <?php $sup_admin = "SELECT * FROM support";
                    ...
                    while($riw =mysqli_fetch_array($resa_admin)){
                      ?>
                       <tr><td align="center"><b> <?php echo $riw['id'];?></b></td>
                       <td align="center"><b> <?php echo $riw['name'];?></b></td>
                       <td align="center"><b><?php  echo $riw['email'];?></b>
                        </td>
                       <td align="center"><b><?php  echo $riw['username'];?>
                        </td></b>
                        <td align="center"><b><?php echo $riw['password'];?></b>
                        </td>
                        <td align="center"><b><?php echo $riw['phone'];?></b>
                        </td>
                        <td>
                        <?php
