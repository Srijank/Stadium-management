...
<div style="position: relative;left:10%;" class="noprint">
<?php
...
<div style="position:absolute;left:75%;top:19%" class="noprint">
 <?php
 ...
 <div style="position:absolute;left:90%;top:19%" class="noprint">
...
<h1 align="center">Lets Fight together</h1><br>
   ...
   <?php
      echo '<a href="/Stadium/php/updateticket.php?ih=' . $raw['id'] .'&name=' . $raw['name'] .'&email=' . $raw['email'] .'&ph=' . $raw['phonenumber'] .'&dat=' . $raw['dat'] .'&ix=' . $raw['ac'] .'">
      <button style="background-color:green;color:white;border-radius:5%;font-size:20px;">Update</button></a>
      <a href="delete.php?rn=' . $raw['id'] .'">
...
<?php
  ...
  echo '<h3 align="center">You havent Booked any Tickets.Go and Book Ticket&nbsp<a href="/Stadium/php/events.php"><button background-color="green">Book Now </button></h3>' ;
 }
 ?>
        </body>
        </html>
