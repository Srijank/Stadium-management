...
include 'connect.php';
     ...
     $j =$_GET['user'];
       ...
       $sql= "SELECT * FROM  users WHERE username= '$j' AND password= '$password' ";
...
$h = "SELECT * FROM calender ORDER by dates ASC ";
         ...
         while($row= mysqli_fetch_array($re) ){
            ?>
                       ...
                       echo '<td> 
                    <p style="color:red;">
            <b><a href="http://localhost/Stadium/php/ticket.php?event='.$row['dates'] .' target="_blank "
              style="text-decoration:none;color: green;">Available/Book Now</a></b>
          </p>
        </td>';
        ?>
                    </tr>
